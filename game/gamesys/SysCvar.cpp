...
idCVar si_buyModeStartingCredits(	"si_buyModeStartingCredits",	"15000",			CVAR_GAME | CVAR_SERVERINFO | CVAR_INTEGER, "Amount of credits players start with in buying enable games" );
...
idCVar si_buyModeMinCredits(		"si_buyModeMinCredits",			"10000",			CVAR_GAME | CVAR_SERVERINFO | CVAR_INTEGER, "Minimum amount of credits in buying enable games" );
